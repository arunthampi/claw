class Extractor
  ...
  # * f - forward line
  def self.mark_message_lines(lines)
    markers = []
    counter = 0
  ...
  # ['Hello']
  #
  def self.process_marked_lines(lines, markers)
  ...
  private
  def self.get_delimiter(message)
